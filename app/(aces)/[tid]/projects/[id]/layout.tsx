...
export default async function ProjectLayout({ params, children }: WithIdLayoutProps) {
  ...
  const sections = [
    { label: "Settings", href: `/${params.tid}/projects/${params.id}/settings` },
    { label: "Peserta", href: `/${params.tid}/projects/${params.id}/persona` },
    { label: "Deployment", href: `/${params.tid}/projects/${params.id}/deployment` },
    { label: "Report", href: `/${params.tid}/projects/${params.id}/report` },
  ];
  return (
